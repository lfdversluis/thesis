...
Once performance regression is detected, developers have to spend extra efforts determining what causes said regression, especially when a lot of changes have been applied since the last measurement.
...
\emph{Software performance engineering} (SPE) \enquote{provides a systematic, quantitative approach to constructing software systems that meet performance  objectives} (Smith et al. 2003) \cite{smith2003best}. 
In SPE, the 
