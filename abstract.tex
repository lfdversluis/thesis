...
When making changes it is essential to ensure no \emph{performance regression} has occurred i.e. the program performs slowly or consumes more resources than previous versions.
