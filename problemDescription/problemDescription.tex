...
To be able to conclude performance has improved, we can apply software performance engineering.
This study focuses on introducing benchmarks and regression testing using said benchmarks to prevent performance regression.
