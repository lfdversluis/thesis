...
As every user is both a sever and a client at the same time, an arbitrarily number of peers may connect to the user requesting data.

Tribler has been downloaded approximately 1.8 million times, has more than 2 thousand monthly active users and anticipating more growth in the near future.
...
As exit nodes are scarce, many relays and leechers will connect to an exit node, significantly increasing the workload.
