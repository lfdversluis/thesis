...
The next step is to introduce a performance regression system, tracking changes in vital numbers such as CPU consumption or I/O produced.
...
Therefore, it is important to create a reference benchmark which has a close resemblance to real world usage.
Changes in performance will then reflect real world user experience.
...
The objective of this thesis is to introduce a I/O \todo{remove I/O?} regression test system and to improve the performance and responsiveness of Tribler.
