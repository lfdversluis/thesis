...
Tribler's goal is to offer a YouTube-like experience with similar performance.
...
However, especially the poor performance of Tribler is hampering wide-spread adaption and usage. Figure~\ref{fig:tribler_roadmap} shows part of the six main uncompleted roadmap items.
...
One could state there currently is a lack of insight in these metrics, or a lack of \emph{software performance engineering}, causing the exact extent of the problem to be unknown.
...
Since 2005 Tribler is under continuous development, over 17 thousands commits have been made, spanning more than a decade \cite{openhub2016tribler}.
...
After this, a decorators was added to the Dispersy code base to track and log if a function was running longer than a fixed amount of time.
While this implementation does provide some insight, it workings are crude and only covering some of the functions present.
...
It is clear that there is a lack of software performance engineering. 
Performance has never been one of the priorities in Tribler's lifetime; only 36 tickets on GitHub are (indirectly) related to performance out of the 648.
