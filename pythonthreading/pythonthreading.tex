...
To ensure I/O operations do not block the main thread, the I/O can be moved to a separate thread, returning a deferred \todo{leg uit waarom returnt ie een deferred? - hier verder gaan met reviewen.}.
