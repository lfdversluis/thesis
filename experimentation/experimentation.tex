...
The reduction in response times (on average) ranges between 32.1\% and 57.5\%. \todo{meer uitleggen}
The standard deviation is also significantly less, indicating the response times are more stable than the synchronous version. \todo{meer uitleggen}
\todo{Uitleggen dat de responses/s percentueel afnemen, maar dat als je meer scheduled de twisted event loop bij 20 wat meer probeert af te handelen in vergelijke met 15 en daarom dus responses/s nog wel toeneemt, maar percentueel gezien niet.}
...
Figure~ \todo{todo} shows the comparison graph generated.
...
These indicators are visible in Figure A and B for a ok and not ok respectively \todo{todo}.
\todo{Misschien nog een scriptje maken dat faalt as performance in gedropt, een bolletje erbij in Tribler jenkins PR ding?}
