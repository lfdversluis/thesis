...
\begin{table}[h]
	...
	\begin{tabular}{l|l}
		...
		CPU					& 1 Core with four 2.5Ghz processors \\ 
		HDD					& 25 GB  \\ 
		RAM					& 8 GB  \\
	\end{tabular}
\end{table}
...
To observe the impact of each query separately, an infrastructure was created that automatically provides insight into the most expensive, most executed, and longest duration queries. With one million queries per hours, Tribler developers desperately need such a tool.
...
The breakdown of Tribler's database queries can be found in Table~ and Table~ , whereas the breakdown of Dispersy's queries can be found in Table~ and Table~. \todo{Run this experiment on the ubuntu 15.10 machine.}
